    ...
    <div id="documenter_content">
        <section id="install">
            <div class="page-header">
                <h3>Install MKBauty eCommerce Add-on</h3>
                <hr class="notop">
            </div>
            <p>It is presumed that you already have MKBauty installed on your server. If you login to MKBauty, you should see 'Addon List' menu item on your admin panel/dashboard sidebar. Click 'Addon List' and on the following page you should see 'MKBauty eCommerce' listed along with other Add-ons. Unless already installed, it should show 'Buy Now' and 'Install' button. When installed, it will show 'Update' button.</p>
        ...
        <section id="product">
            ...
            <p>Adding product for eCommerce is just like adding product for POS/inventory in MKBauty.In addition to existing input fileds on <a href="{{url('/products/create')}}">'Add Product'</a> page, few eCommerce specific input fields are added. These input options are listed right at the bottom of the 'Add Product' page.</p>
            <p>
            ...
            <p><strong>Note: </strong>If you have been using MKBauty before purchasing the eCommerce add-on, you'll have to edit the products you want to list on your eCommerce website and check this option for those products.</p>
            <h4>In Stock</h4>
