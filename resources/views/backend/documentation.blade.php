...
<body>
    ...
    <div id="documenter_content">
        ...
        <section id="addon">
            ...
            <h2><strong>MKBauty WooCommerce</strong></h2>
            <p>Imagine you have an existing WooCommerce website. Now you want to use MKBauty and also want to synchronize your WooCommerce website with MKBauty. If you want to do so then this is the ultimate solution you are looking for. MKBauty WooCommerce addon comes with complete synchronization with your WooCommerce website. You can synchronize your orders from WooCommerce to MKBauty. Also you can can synchronize products, categories from MKBauty to WooCommerce. And you have to map your MKBauty taxes with WooCommerce taxes.</p>
            ...
            <p>If you go to the WooCommerce section you will get all the necessary options to sync your Wocommerce categories, products, taxes and orders. You can also sync products from MKBauty to WooCommerce from the product create or edit page.</p>
            <p>
            ...
            <h2><strong>MKBauty eCommerce</strong></h2>
            <p>For MKBauty eCommerce installation and documentation , please visit <a href="{{url('/ecommerce-documentation')}}">MKBauty eCommerce Docs</a></p>
        </section>
